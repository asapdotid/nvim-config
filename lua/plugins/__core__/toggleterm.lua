return {
  {
    ...
    dependencies = {
      ...
      "nvim-lua/plenary.nvim",
      {
        ...
        config = function()
          ...
          map({ "n", "t" }, "<leader>tt", cmd "Telescope toggleterm_manager", { desc = "telescope toggleterm" })
        end,
      },
    },
    config = function()
    ...
    keys = function()
      ...
      map({ "n", "t" }, "<A-`>", cmd "ToggleTerm direction=float", opts)
      map({ "n", "t" }, "<leader>tt", cmd "ToggleTerm direction=float", { desc = "terminal float", noremap = true })
      map({ "n", "t" }, "<A-t>", cmd "ToggleTerm direction=float", opts)
      ...
      -- map({ "n", "t" }, "<A-h>", cmd "ToggleTerm size=20 direction=horizontal", { desc = "terminal horizontal" })
      -- map({ "n", "t" }, "<A-v>", cmd "ToggleTerm size=80 direction=vertical", { desc = "terminal vertical" })
    end,
  },
}
