return {
   {
      ...
      keys = function()
        ...
        map("n", "<leader>xL", __Utils.cmd "Trouble loclist toggle", { desc = "location list (trouble)" })
        map("n", "<leader>xQ", __Utils.cmd "Trouble qflist toggle", { desc = "quickfix list (trouble)" })
        map("n", "[q", function()
